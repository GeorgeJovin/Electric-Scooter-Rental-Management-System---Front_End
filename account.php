...
<div class="container">
  ...
  <h2>E<span>GO</span> Account</h2><br>
          <div class="row">
            <div class="col"></div>
           <div class="col-6"> 
  ...
  <p> Welcome! <span style="color:#33CC00"><?php echo $username; ?></span> </p>
          ...
          <tr>
           ...
           <div class="row">
            ...
            <div class="col-sm-6">
         <a href="change-password.html"><button type="button" class="btn btn-warning">Change Password</button></a>
            </div>
           </div>
        </div>
        <div class="col-sm-3">
